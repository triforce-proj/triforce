...
contract PyukumukuTokenWrapper {
	using SafeMath for uint256;
	IERC20 public pyukumuku;

	constructor(IERC20 _pyukumukuAddress) public {
		pyukumuku = IERC20(_pyukumukuAddress);
	}
...
contract pYUKMinter_NFT_Pool is PyukumukuTokenWrapper, Ownable {
	ERC1155Tradable public pYUKMinter;
  ...
  function setpYUKMinterAddress(address _pYUKMinterAddress) public onlyOwner {	
	  pYUKMinterAddress = _pYUKMinterAddress;	
  }	

  function setPyukumukuAddress(address _pyukumukuAddress) public onlyOwner {	
	  pyukumukuAddress = _pyukumukuAddress;	
  }	
