...
contract StrategyAutoCake is Ownable, Pausable {
    ...
    address constant public pyuk = address(0x6f412cA22db8B0e8Db64ccfDD0765bBBcba792E3);
    address public want;
    ...
    function chargeFees() internal {
        ...
        IUniswapRouter(unirouter).swapExactTokensForTokens(treasuryHalf, 0, wbnbToPyukRoute, treasury, now.add(600));
