...
// File: contracts/PYUK/interfaces/common/IUniswapRouter.sol
...
// File: contracts/PYUK/interfaces/auto/IAutoFarmV2.sol
...
// File: contracts/PYUK/interfaces/auto/IStratX.sol
...
// File: contracts/PYUK/interfaces/pancake/IMasterChef.sol
...
// File: contracts/PYUK/strategies/Auto/StrategyAuto.sol
...
contract StrategyAutoCake is Ownable, Pausable {
     ...
     * {tfc} - tfc token, used to send funds to the treasury.
     */
    address constant public wbnb = address(0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c);
    address constant public Auto = address(0xa184088a740c695E156F91f5cC086a06bb78b827);
    address constant public pyuk = address(0xc8126aae93E79CDcD618c2dA2Aa303A2e41dA126);
    address constant public tfc = address(0x339f6e1553E923FD27412dfaF18b5721EA580A15);
    address public want;
     ...
     */
    address constant public rewards  = address(0xA8Bb548772296C540826715bAd1C8F1429f38193);
    address constant public treasury = address(0xf8901b5F63A7062f6F3F75f9fd69faAECF697e0c);
     ...
     *
     * {REWARDS_FEE} - 3% goes to PYUK holders through the {rewards} pool.
     ...
     * {wbnbToPyukRoute} - Route we take to go from {wbnb} into {pyuk}.
     * {wbnbToPyukRoute} - Route we take to go from {wbnb} into {tfc}.
    ...
    address[] public wbnbToTFCRoute = [wbnb, tfc];
     ...
     * 3. It charges the system fee and sends it to PYUK stakers.
    ...
    function chargeFees() internal {
        ...
        uint256 tfcPyukHalf = treasuryHalf.div(2);
        IERC20(wbnb).safeTransfer(treasury, treasuryHalf);
        IUniswapRouter(unirouter).swapExactTokensForTokens(tfcPyukHalf, 0, wbnbToPyukRoute, treasury, now.add(600));
        IUniswapRouter(unirouter).swapExactTokensForTokens(tfcPyukHalf, 0, wbnbToTFCRoute, treasury, now.add(600));
    ...
    /**
    * @dev Updates address of the vault.
