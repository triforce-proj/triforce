...
contract PYUKUMUKU_POOLS is Ownable {
    ...
    uint256 public blockRewardPercentage = 350; // The percentage used for pyukumukuPerBlock calculation.
    ...
    function setBlockRewardPercentage(uint256 _blockRewardPercentage) external onlyOwner {
        require(_blockRewardPercentage >= 0 && _blockRewardPercentage <= 400, "Value is outside of range 0-400");
