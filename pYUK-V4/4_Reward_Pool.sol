...
// File: contracts/pYUK/IRewardDistributionRecipient.sol
...
// File: contracts/pYUK/LPTokenWrapper.sol
...
contract TokenWrapper {
    ...
    IERC20 public pYUK = IERC20(0xc8126aae93E79CDcD618c2dA2Aa303A2e41dA126);
    ...
    function stake(uint256 amount) public {
        ...
        pYUK.safeTransferFrom(msg.sender, address(this), amount);
    }

    function withdraw(uint256 amount) public {
        _totalSupply = _totalSupply.sub(amount);
        _balances[msg.sender] = _balances[msg.sender].sub(amount);
        pYUK.safeTransfer(msg.sender, amount);
    }
}

// File: pYUK/RewardPool.sol
...
contract RewardPool is TokenWrapper, IRewardDistributionRecipient, ReentrancyGuard {
    ...
    uint256 public maxStakeAmount = 25000*1e18;
    ...
    function stake(uint256 amount) public updateReward(msg.sender) {
        ...
        require(amount.add(balanceOf(msg.sender)) <= maxStakeAmount, "Cannot stake more than maxStakeAmount");
