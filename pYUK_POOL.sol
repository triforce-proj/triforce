...
contract PYUKUMUKU_POOLS is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
	...
	// PYUKUMUKU tokens distributed per block. Use getPyukumukuPerBlock() to get the updated reward.
	uint256 private pyukumukuPerBlock; 
	...
	// The timestamp when the block pyukumukuPerBlock was last updated.
    ...
    uint256 public blockRewardPercentage = 340; // The percentage used for pyukumukuPerBlock calculation.
    ...
    function safeTokenTransfer(address _to, uint256 _amount) internal {
        ...
        require(pyukumuku.transfer(_to, amount), "Safe token transfer failed");
    }
